...
def make_chart_simple_line_chart(plt):
    ...
    pyplot.savefig('./fig/01_make_chart_simple_line_chart.png')
    plt.show()
...
def make_chart_simple_bar_chart(plt):
    ...
    plt.xticks([i + 0. for i, _ in enumerate(movies)], movies)
    pyplot.savefig('./fig/02_make_chart_simple_bar_chart.png')
    plt.show()
...
def make_chart_histogram(plt):
    ...
    pyplot.savefig('./fig/03_make_chart_histogram.png')
    plt.show()
...
def make_chart_misleading_y_axis(plt, mislead=True):
    ...
    if mislead:
        ...
        pyplot.savefig('./fig/04_make_char_misleading_y_axis.png')   
    else:
        plt.axis([2012.5,2014.5,0,550])
        plt.title("Not So Huge Anymore.")  
        pyplot.savefig('./fig/04_make_char_nomisleading_y_axis.png')   
    plt.show()
...
def make_chart_several_line_charts(plt):
    ...
    pyplot.savefig('./fig/05_make_chart_several_line_charts.png')
    plt.show()
...
def make_chart_scatter_plot(plt):
    ...
    pyplot.savefig('./fig/06_make_chart_scatter_plot.png')
    plt.show()
...
def make_chart_scatterplot_axes(plt, equal_axes=False):
    ...
    pyplot.savefig('./fig/07_make_chart_scatterplot_axes.png')
    plt.show()
...
def make_chart_pie_chart(plt):
    ...
    plt.axis("equal")
    pyplot.savefig('./fig/08_make_chart_pie_chart.png')
    plt.show()
